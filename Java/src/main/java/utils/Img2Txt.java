...
public class Img2Txt extends javax.swing.JFrame {
	...
	public Img2Txt() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(Img2Txt.class.getResource("/imagenes/crop.png")));
		setTitle("Img To TXT");
		initComponents();
	}
	...
	private void initComponents() {
		...
		start.setIcon(new ImageIcon(Img2Txt.class.getResource("/imagenes/actualizar.png")));
		...
		label4.setIcon(new ImageIcon(Img2Txt.class.getResource("/imagenes/import.png")));
		...
		btnNewButton.setIcon(new ImageIcon(Img2Txt.class.getResource("/imagenes/copy.png")));
		...
		btnNewButton_1.setIcon(new ImageIcon(Img2Txt.class.getResource("/imagenes/clean.png")));
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					carpeta += Img2Txt.getSeparador() + "output";
		...
		btnNewButton_2.setIcon(new ImageIcon(Img2Txt.class.getResource("/imagenes/folder.png")));
		...
		multiple.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				try {
					...
					if (Metodos.saberExtension(ruta.getText()).contains(".")) {
						ruta.setText(ruta.getText().substring(0, ruta.getText().lastIndexOf(Img2Txt.getSeparador())));
					}
	...
	public static void Img2Txt(String args[]) {
